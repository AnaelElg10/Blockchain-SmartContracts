...
import SocialMediaInputs from "./social-media-inputs";
  ...
  const handleImagesChange = async (files: File[]) => {
    ...
    try {
      ...
      const options = {
        ...
        headers: {
          Authorization:
            "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..Bs3sGO5MsWAQNthFoH3wd17q9JgMMRtuCoFZvGQzlYI",
        },
        body: form,
      };
